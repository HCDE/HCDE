...
MapFlagHandlers[] =
{
	...
	{ "compat_nofriendlyspawn",			MITYPE_COMPATFLAG, 0, COMPATF2_NOFRIENDLYSPAWN },
	...
	if (gameinfo.gametype == GAME_Doom)
	{
		...
		if (comp >= 0)
		{
			...
			else if (length == 5 && !strnicmp("mbf21", data, 5))
			{
				...
				flags2 =
					COMPATF2_EXPLODE1 | COMPATF2_AVOID_HAZARDS | COMPATF2_STAYONLIFT | COMPATF2_POINTONLINE | COMPATF2_RESERVEDLINEFLAG;
			}
		}
	}
